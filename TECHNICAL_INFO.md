# Technical Info — Zone Laser Scoreboard

This document contains the original technical details, packet decoding information, and setup instructions for the Zone Laser Scoreboard system.
